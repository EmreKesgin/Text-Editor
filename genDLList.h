...
public:
    ...
    void deleteN(int n);
    void moveNtoM(int n, int m);
    void replaceNtext(string newText,int n);
    void print();
    void next();
    void prev();
    void printCopy();
    void addToDLLTail(const T& line);
    int abc = 0;
    int abc2 = 1;
    vector<string> vec;
    DoublyLinkedList() {
    ...
    DLLNode<T> *ptr=DoublyLinkedList<T>::head;
protected:
    DLLNode<T> *head, *tail;
